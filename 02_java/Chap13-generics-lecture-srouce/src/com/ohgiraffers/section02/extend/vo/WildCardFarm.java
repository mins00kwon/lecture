...
/* 설명: 와일드카드(wildcard)_특수한 기능이 있는 특수기호
*   제네릭 클래스 타입읭 객체를 메소드의 매개변수로 받을 때 타입 변수를 제한할 수 있다
*   <?>: 제한 없음
*   <? extends Type>: 와일드카드의 상한 제한(해당 Type과 Type의 후손을 이용해 생성된 제네릭 인스턴스만 가능)
*   <? super Type>: 와일드카드의 하한 제한(해당 Type 과 Type의 부모를 이용해 생성한 제네릭 인스턴스만 가능
* */
...
public class WildCardFarm {
    ...
    /* 설명: RabbitFarm 중에서도 Bunny 또는 하위 타입이 있는 RabbitFarm 만 가능*/
