...
new normalFunc(); // {} (객체 생성됨)

// 3.  화살표 함수는 arguments를 지원하지 않는다
//      (외부 함수의 arguments가 있다면 외부함수의 arguments가 적용됨(렉시컬 arguments))
const test = ()=>console.log(arguments);
// this와 같이 화살표 함수의 arguments가 아닌 상위 환경의 arguments를 사용하게 된다 (전역 객체의 arguments)
test(1,2,3,4,5);

const test2=function(){
    console.log('normal outer: ', arguments);
    const arrowFunc=()=>console.log('arrow outer: ', arguments);
}
test2(1,2,3,4,5); // normal outer:  [Arguments] { '0': 1, '1': 2, '2': 3, '3': 4, '4': 5 }
